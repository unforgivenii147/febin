...
def find_comments_impl(
    ...
    for pos, ch in enumerate(input_str):
        ...
        current_comment_state, matches = do_action(
            action,
...
def _c_state_transition(state: _CParseState,
    ...
    if state in (
        ...
        if ch == "/":
            return (
                _CParseState.FIRST_SLASH,
                _CAction.COMMENT_MIGHT_START,
            )
        elif ch == '"':
            return (
                _CParseState.STRING_DOUBLE_QUOTES,
                _CAction.NOTHING,
            )
        elif ch == "'":
            return (
                _CParseState.STRING_SINGLE_QUOTES,
                _CAction.NOTHING,
            )
        else:
            return (
        ...
        if ch == '"':
            ...
            return (
                _CParseState.STRING_DOUBLE_QUOTES_ESCAPED,
                _CAction.NOTHING,
            )
        else:
            return (
        ...
        if ch == "'":
            ...
            return (
                _CParseState.STRING_SINGLE_QUOTES_ESCAPED,
                _CAction.NOTHING,
            )
        else:
            return (
...
def _shell_state_transition(
    ...
    if ch is None:
        if state == _ShellParseState.COMMENT:
            return (
                ...
                _ShellAction.COMMENT_ENDS,
            )
        elif state == _ShellParseState.SHEBANG_OR_COMMENT:
            return (
                _ShellParseState.END,
                _ShellAction.SHEBANG_FOUND,
            )
        else:
            return (
                _ShellParseState.END,
    ...
    if state == _ShellParseState.START:
        if ch == "#":
            ...
            return (
                _ShellParseState.STRING_DOUBLE_QUOTES,
                _ShellAction.NOTHING,
            )
        elif ch == "'":
            return (
                _ShellParseState.STRING_SINGLE_QUOTES,
                _ShellAction.NOTHING,
            )
        else:
            return (
                _ShellParseState.NORMAL,
                _ShellAction.NOTHING,
            )
    elif state == _ShellParseState.NORMAL:
        if ch == "#":
            return (
                _ShellParseState.COMMENT,
                _ShellAction.COMMENT_STARTS,
            )
        elif ch == '"':
            return (
                _ShellParseState.STRING_DOUBLE_QUOTES,
        ...
        if ch == '"':
            ...
            return (
                _ShellParseState.STRING_DOUBLE_QUOTES_ESCAPED,
                _ShellAction.NOTHING,
            )
        else:
            return (
        ...
        if ch == "'":
            ...
            return (
                _ShellParseState.STRING_SINGLE_QUOTES_ESCAPED,
                _ShellAction.NOTHING,
            )
        else:
            return (
...
def _xml_state_transition(state: _XMLParseState,
    ...
    if ch is None:
        if state in (
            ...
            return (
                _XMLParseState.END,
                _XMLAction.COMMENT_DISMISSED,
            )
        elif state == _XMLParseState.COMMENT_END_BRACKET:
            return (
                _XMLParseState.END,
                _XMLAction.COMMENT_ENDS,
            )
        else:
            return (
                _XMLParseState.END,
    ...
    if state in (
        ...
        if ch == "<":
            ...
            return (
                _XMLParseState.STRING_DOUBLE_QUOTES,
                _XMLAction.NOTHING,
            )
        elif ch == "'":
            return (
                _XMLParseState.STRING_SINGLE_QUOTES,
                _XMLAction.NOTHING,
            )
        else:
            return (
        ...
        if ch == ">":
            return (
                _XMLParseState.COMMENT_END_BRACKET,
                _XMLAction.NOTHING,
            )
        elif ch == "-":
            return (
        ...
        if ch == '"':
            ...
            return (
                _XMLParseState.STRING_DOUBLE_QUOTES_ESCAPED,
                _XMLAction.NOTHING,
            )
        else:
            return (
        ...
        if ch == "'":
            ...
            return (
                _XMLParseState.STRING_SINGLE_QUOTES_ESCAPED,
                _XMLAction.NOTHING,
            )
        else:
            return (
...
def _blank_state_transition(
    ...
    if state == _BlankParseState.START:
        if ch == "\n":
            return (
                _BlankParseState.MULTI_BLANKLINE,
                _BlankAction.MULTI_BLANKLINE_START,
            )
        elif ch == '"':
            return (
            ...
            return (
                _BlankParseState.NORMAL,
                _BlankAction.NOTHING,
            )
    elif state == _BlankParseState.NORMAL:
        if ch == "\n":
            return (
                _BlankParseState.SINGLE_BLANKLINE,
                _BlankAction.NOTHING,
            )
        elif ch == '"':
            return (
        ...
        if ch == '"':
            ...
            return (
                _BlankParseState.STRING_DOUBLE_QUOTES_ESCAPED,
                _BlankAction.NOTHING,
            )
        else:
            return (
        ...
        if ch == "'":
            ...
            return (
                _BlankParseState.STRING_SINGLE_QUOTES_ESCAPED,
                _BlankAction.NOTHING,
            )
        else:
            return (
