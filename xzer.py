...
def main():
    ...
    logger.info(
        f"Initial directory: {format_size(initial_size)} across {initial_files} files"
    )
    ...
    logger.info("-" * 40)
    logger.info(
        f"Initial: {format_size(initial_size)} across {initial_files} files")
    logger.info(
        f"Final:   {format_size(final_size)} across {final_files} files")
    logger.info(
